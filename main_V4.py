...
if __name__ == "__main__":
    ...
    print("===== AgileRL Online Multi-Agent Demo V4 =====")
    ...
    path = "./models/MATD3_V5"
    filename = "MATD3_trained_agent_V4.pt"
    ...
    # Salvar o gráfico
    plot_path = os.path.join(path, "training_scores_evolution_V4.png")
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    print(f"Gráfico de evolução das pontuações salvo em: {plot_path}")
    
    # Salvar dados das pontuações em arquivo numpy
    scores_data_path = os.path.join(path, "training_scores_history_V4.npy")
